  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <Text style={styles.sectionTitle}>Đang ngập nặng</Text>
        <Pressable style={styles.itemCard} onPress={() => router.push('/camera-detail')}>
          <View style={styles.itemHeader}>
            <Text style={styles.itemTitle}>Huỳnh Tấn Phát, Quận 7</Text>
            <View style={styles.chipRed}>
              <Text style={styles.chipRedText}>Ngập 30cm</Text>
            </View>
          </View>
          <Text style={styles.itemDesc}>Đoạn từ Trần Xuân Soạn đến cầu Phú Xuân. Giao thông tê liệt hoàn toàn.</Text>
        </Pressable>

        <Text style={[styles.sectionTitle, { marginTop: 24 }]}>Nguy cơ ngập cao</Text>
        <Pressable style={styles.itemCard} onPress={() => router.push('/camera-detail')}>
          <View style={styles.itemHeader}>
            <Text style={styles.itemTitle}>Nguyễn Hữu Cảnh, Bình Thạnh</Text>
            <View style={styles.chipYellow}>
              <Text style={styles.chipYellowText}>Ngập 10cm</Text>
            </View>
          </View>
          <Text style={styles.itemDesc}>Mực nước đang dâng nhanh do triều cường kết hợp mưa lớn.</Text>
        </Pressable>
      </ScrollView>
    </View>
  );
